...
Each rule is defined in a JSON file located in the [PrivilegeZoneRules](https://github.com/SpecterOps/openhound-github/tree/main/extension/privilege_zone_rules) directory of the GitHound repository.
