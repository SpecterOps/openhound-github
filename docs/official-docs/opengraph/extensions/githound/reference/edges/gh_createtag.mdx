...
| Start | Kind | End |
|-------|-----------|-------|
| [GH_RepoRole](/opengraph/extensions/githound/reference/nodes/gh_reporole) | GH_CreateTag | [GH_Repository](/opengraph/extensions/githound/reference/nodes/gh_repository) |
