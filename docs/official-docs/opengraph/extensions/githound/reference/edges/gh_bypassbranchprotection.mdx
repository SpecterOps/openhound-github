...
| Start | Kind | End |
|-------|-----------|-------|
| [GH_RepoRole](/opengraph/extensions/githound/reference/nodes/gh_reporole) | GH_BypassBranchProtection | [GH_Repository](/opengraph/extensions/githound/reference/nodes/gh_repository) |
