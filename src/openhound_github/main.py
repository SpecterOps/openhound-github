...
def preproc(ctx: PreProcContext):
    ...
    return {
        ...
        "enterprise_saml_provider": "enterprise_saml_provider",
        "enterprise_saml_service_providers": "enterprise_saml_service_providers",
        "enterprise_saml_issuers": "enterprise_saml_issuers",
        "enterprise_saml_assertion_consumer_services": "enterprise_saml_assertion_consumer_services",
        "org_saml_service_providers": "org_saml_service_providers",
        "org_saml_issuers": "org_saml_issuers",
        "org_saml_assertion_consumer_services": "org_saml_assertion_consumer_services",
