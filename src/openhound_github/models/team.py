...
class GHTeamProperties(GHNodeProperties):
    ...
    slug: str = field(
        default="", metadata={"description": "The team's URL-safe slug identifier."}
    )
    description: str | None = field(
        default=None, metadata={"description": "The team's description."}
    )
    privacy: str | None = field(
        default=None,
        metadata={
            "description": "The team's privacy level (e.g., `visible`, `secret`)."
        },
    )
    ...
    query_first_degree_members: str = ""
    query_unrolled_members: str = ""
    query_first_degree_maintainers: str = ""
    query_unrolled_maintainers: str = ""
    query_repositories: str = ""
    query_child_teams: str = ""
