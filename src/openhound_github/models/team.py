...
class GHTeamProperties(GHNodeProperties):
    ...
    Attributes:
        ...
        query_first_degree_maintainers: Query for first degree maintainers.
        query_unrolled_maintainers: Query for unrolled maintainers.
        query_repositories: Query for repositories.
        query_child_teams: Query for child teams.
    """

    collected: bool = True

    # TODO: Check permissions field
    github_team_id: str | None = None
    slug: str | None = None
