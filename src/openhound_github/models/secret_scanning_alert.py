...
class SecretScanningAlert(BaseAsset):
    ...
    def _repo_viewer_edges(self):
        ...
        for (
            role_node_id,
        ) in self._lookup.repo_role_node_ids_with_view_secret_scanning_alerts(
    ...
    def _org_viewer_edges(self):
        ...
        for (
            role_node_id,
        ) in self._lookup.org_role_node_ids_with_view_secret_scanning_alerts(
            self.org_login
        ):
            yield Edge(
                kind=ek.CAN_READ_SECRET_SCANNING_ALERT,
    ...
    def edges(self):
        ...
        yield from self._valid_token_edge
