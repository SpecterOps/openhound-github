...
class GHOrganizationProperties(GHNodeProperties):
    ...
    Attributes:
        ...
        query_personal_access_tokens: Query for personal access tokens.
        query_secret_scanning_alerts: Query for secret scanning alerts.
        query_identity_provider: Query for identity provider.
        query_app_installations: Query for app installations.
        query_organization_secrets: Query for organization secrets.
